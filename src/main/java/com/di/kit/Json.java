...
public class Json {
    ...
    public <T> String toJson(T o) {
        if (o == null) {
            ...
            return str.deleteCharAt(str.length() - 1).append("}").toString();
        } else if (o.getClass() != Object.class && o.getClass() != Class.class) {
            StringBuilder str = new StringBuilder().append("{");
            try {
    ...
    public <T> List<T> toObjects(String json, Class<T> c) {
        ...
        List<?> os = (List<?>) toObjectVal(toObject(json), List.class);
        for (Object o : os) {
            T o1 = (T) toObjectVal(o, c);
            list.add(o1);
        }
        return list;
    }
    ...
    private Object toObjectVal(Object val, Class<?> c) {
        try {
            if (val == null) {
                ...
                return val;
            } else if (c != Object.class && c != Class.class) {
